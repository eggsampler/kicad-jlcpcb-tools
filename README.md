...
The Flatpak installation of KiCAD currently does not ship with pip and requests installed. The latter is required for the plugin to work.
...
You can download Matthews file from GitHub as well as manage your own corrections in the Rotation manager.
